...
static const char *funny_messages[][2] = {
	...
	{"GUYS", "DAVE IN THREE DEE"},
	{"MOLDY", "STOP TROLLING ME"},
	{"YOU WANNA KNOW SOMETHING", "TROLLED"},
	{"TROLLING DAY", "MARCH TWENTY EIGHTH"},
	{"BALDI", "BASIC"},
	{"YOU CAN CORD", "THIS GAME"},
	{"DCNICK", "SETTING STANDARDS"},
	{"MR BAMBI", "FUNNY WEEK"},
	{"NEVER LOOK AT", "KINGASSRIPPER"},
	{"BAMBI SMASH", "HIS PHONE"},
	{"MARCELLO", "BOTTOM TEXT"},
	{"DOPE ASS GAME", "PLAYSTATION MAGAZINE"},
	{"THIS WILL BE DAVE GRAPHICS", "ON PSX"},
	{"POOR DAVE", "IN WHEELCHAIR"},
	{"NOT FUNNY", "DIDNT LAUGH"},
	{"MOLDY ADD", "DAVE CORRUPTION MOD"},
	{"USE A CONTROLLER", "TRY SUPERNOVAE"},
	{"DAVE REALLY WENT", "POGGERS"},
	{"AMONG US", "HOT MOMENTS"},
	{"MOLDY X", "NO ONE HE IS SINGLE"},
	{"FAMILY GUY", "FUNNY MOMENTS"},
	{"JOHN PAUL", "BIGGEST SUPPORTER NGL"},
	{"UGH", "UGH"},
	{"PLAYING ON EPSXE HUH", "YOURE THE PROBLEM"},
	{"NEXT IN LINE", "ATARI JAGUAR"},
	{"IS THIS", "ANIMAL CROSSING"},
	{"HAHAHA", "I DONT CARE"},
	{"DA BABY", "GONE FOR THE NIGHT"},
...
void Menu_Load(MenuPage page)
{
	...
	menu.gf = Char_GF2_New(FIXED_DEC(62,1), FIXED_DEC(-12,1));
		...
		case MenuPage_Opening:
		{
			...
			else
			{
				...
				//Fallthrough
					case 2:
					case 1:
						menu.font_bold.draw(&menu.font_bold, "THEBUILDERXD",   SCREEN_WIDTH2, SCREEN_HEIGHT2 - 32, FontAlign_Center);
						menu.font_bold.draw(&menu.font_bold, "CYNDAQUILDAC", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 16, FontAlign_Center);
						menu.font_bold.draw(&menu.font_bold, "ERIZUR",   SCREEN_WIDTH2, SCREEN_HEIGHT2,      FontAlign_Center);
						menu.font_bold.draw(&menu.font_bold, "AND OUR WONDERFUL CONTRIBUTORS", SCREEN_WIDTH2, SCREEN_HEIGHT2 + 16, FontAlign_Center);
						break;
				...
				//Fallthrough
					case 14:
						menu.font_bold.draw(&menu.font_bold, "DAVE AND BAMBI", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 8, FontAlign_Center);
				//Fallthrough
					case 13:
	...
	//Fallthrough
		...
		case MenuPage_Story:
		{
			static const struct
			{
				...
				{"1", StageId_2_1, "DAVES FUN RAPPING BATTLE", {"HOUSE", "INSANITY", "POLYGONIZED"}},
				{"2", StageId_3_1, "MR BAMBI FUN CORN MAZE", {"BLOCKED", "CORN THEFT", "MAZE"}},
				{"3", StageId_4_1, "THE FINALE", {"SPLITATHON", NULL, NULL}},
			};
		...
		case MenuPage_Freeplay:
		{
			static const struct
			{
				...
				{StageId_1_4, 0xFFB21B62, "TUTORIAL", true},
				{StageId_2_1, 0xFF4059E1, "HOUSE", true},
				{StageId_2_2, 0xFF4059E1, "INSANITY", true},
				{StageId_2_3, 0xFF4059E1, "POLYGONIZED", true},
				{StageId_2_4, 0xFF4059E1, "BONUS SONG", true},
				{StageId_3_1, 0xFF00A012, "BLOCKED", true},
				{StageId_3_2, 0xFF00A012, "CORN THEFT", true},
				{StageId_3_3, 0xFF00A012, "MAZE", true},
				{StageId_4_1, 0xFF00E1E1, "SPITATHON", false},
				{StageId_4_2, 0xFF00A012, "SUPERNOVAE", true},
				{StageId_4_3, 0xFF00A012, "GLITCH", true},
				{StageId_4_4, 0xFF00A012, "VS DAVE THANKSGIVING", true},
				{StageId_5_1, 0xFF00A012, "CHEATING", true},
				{StageId_5_2, 0xFF00A012, "UNFAIRNESS", true},
				{StageId_5_3, 0xFF00A012, "MEALIE", true},
				{StageId_1_1, 0xFF4059E1, "FURIOSITY", true},
				{StageId_1_2, 0xFF4059E1, "OLD HOUSE", true},
				{StageId_1_3, 0xFF4059E1, "OLD INSANITY", true},
				{StageId_6_1, 0xFF00A012, "OLD BLOCKED", true},
				{StageId_6_2, 0xFF00A012, "OLD CORN THEFT", true},
				{StageId_6_3, 0xFF00A012, "OLD MAZE", true},
				{StageId_7_1, 0xFF00A012, "BETA MAZE", true},
				{StageId_7_2, 0xFF00E1E1, "OLD SPLITATHON", false},
				{StageId_7_3, 0xFF00A012, "SCREWED", true},
				{StageId_7_4, 0xFF00A012, "SECRET", true},
			};
		...
		case MenuPage_Mods:
		{
			static const struct
			{
				...
				{StageId_Kapi_2, "   VS DAVE AND BAMBI PORT ", false},				
				...
				{StageId_Clwn_1, "MOLDYGH", false},
				{StageId_Clwn_1, "   MAIN DEVELOPER ", false},
				{StageId_Clwn_1, "MISSINGTEXTUREMAN", false},
				{StageId_Clwn_1, "   CO DEVELOPER ", false},
				{StageId_Clwn_1, "RAPPAREP LOL", false},
				{StageId_Clwn_1, "   ARTIST ", false},
				{StageId_Clwn_1, "THEBUILDERXD", false},
				{StageId_Clwn_1, "   OG DISTRIBUTOR ", false},
				{StageId_Clwn_1, "CYNDAQUILDAC", false},
				{StageId_Clwn_1, "   DEVELOPER ", false},
				{StageId_Clwn_1, "ERIZUR", false},
				{StageId_Clwn_1, "   PROGRAMMER AND ASSETS ", false},
				{StageId_Clwn_1, "TMPLER", false},
				{StageId_Clwn_1, "   PROGRAMMER ", false},
				{StageId_Clwn_1, "MARCELLO", false},
				{StageId_Clwn_1, "   MR BAMBI LMAO ", false},
				{StageId_Clwn_1, "STATS45", false},
				{StageId_Clwn_1, "   EMOTIONAL SUPPORT ", false},
				{StageId_Clwn_1, "TOASTERMIKE", false},
				{StageId_Clwn_1, "   THREEDEE BACKGROUND ", false},
				{StageId_Clwn_1, "ALEXANDER COOPER", false},
				{StageId_Clwn_1, "   COMPOSER OF MEALIE ", false},
				{StageId_Clwn_1, "ARCHWK", false},
				{StageId_Clwn_1, "   CREATOR OF SUPERNOVAE ", false},
				{StageId_Clwn_1, "THE BONEYARD", false},
				{StageId_Clwn_1, "   CREATOR OF GLITCH ", false},
				{StageId_Clwn_1, "OBVIOUS NINJA", false},
				{StageId_Clwn_1, "   BOYFRIEND HARMOR PRESENT ", false},
				{StageId_Clwn_1, "KADEDEVELOPER", false},
				{StageId_Clwn_1, "   KADE ENGINE ", false},
				{StageId_Clwn_1, "JAMSYBOB REDSTONE", false},
				{StageId_Clwn_1, "   CHART FIXING HELP ", false},
				{StageId_Clwn_1, "UNSTOPABLE", false},
				{StageId_Clwn_1, "   PLAYTESTER ", false},
